...
The spectral gap ratio in non-canonical organization domain is the same as the spectral gap ratio for a single-source receiver sampling mask.
...
Wavefield reconstruction of a single frequency slice.
